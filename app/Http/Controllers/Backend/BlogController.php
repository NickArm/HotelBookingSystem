...
class BlogController extends Controller
{
    ...
    public function AllBlogPost()
    {
        ...
        return view('backend.blog.all_post', compact('post'));
    ...
    public function AddBlogPost()
    {
        ...
        return view('backend.blog.add_post', compact('blogcat'));
    }// End Method
    ...
    public function EditBlogPost($id)
    {
        ...
        return view('backend.blog.edit_post', compact('blogcat', 'post'));
