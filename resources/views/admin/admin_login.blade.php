								...
								<div class="">
									...
									<div class="form-body">
									 ...
									 <form class="row g-3"  method="POST" action="{{ route('login') }}">
        									@csrf
											<div class="col-12">
												<label for="inputEmailAddress" class="form-label">Email or Name or Phone</label>
												<input type="text" class="form-control" id="login" name="login" @error('login') is-invalid @enderror placeholder="jhon@example.com">
												@error('login')
